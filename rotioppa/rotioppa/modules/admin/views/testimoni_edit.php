...
if(isset($input) && $input){
	...
	$title=$detail_info->pengirim;
	$summary=$detail_info->testimoni;
...
<tr>
	<th>Pengirim</th>
	<td><input type="text" name="title" class="the_title" style="width:700px; height:20px" value="<?=$title?>" /></td>
</tr>
<tr>
	<th>Testimoni</th>
	<td><textarea name="summary" class="the_summary" style="width:700px;height:400px;"><?=$summary?></textarea></td>
</tr>
<tr>
<tr>
	<th></th><td>
