...
| Default value : (none).
*/
$config['sig_image_path'] = 'assets/cap/img.png';
...
| Default values : 0. 
*/
$config['sig_text_start_position'] = 10;
...
*/
$config['sig_text_font'] = 'assets/cap/mmrtext.ttf';//'path/to/arial.ttf';
...
$config['sig_text_font_size_max'] = 18;  
